...
namespace MvcPelicula.Controllers
{
    public class PeliculasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Titulo,FechaLanzamiento,Genero,Precio,Calificacion")] Pelicula pelicula)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Titulo,FechaLanzamiento,Genero,Precio,Calificacion")] Pelicula pelicula)
        {
            if (ModelState.IsValid)
            {
